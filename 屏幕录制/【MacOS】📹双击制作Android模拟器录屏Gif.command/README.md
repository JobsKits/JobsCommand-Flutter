# `【MacOS】📹双击制作Android模拟器录屏Gif.command`
...
- 本自述文件对应脚本：`【MacOS】📹双击制作Android模拟器录屏Gif.command`。
...
```shell
chmod +x './【MacOS】📹双击制作Android模拟器录屏Gif.command'
'./【MacOS】📹双击制作Android模拟器录屏Gif.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】📹双击制作Android模拟器录屏Gif.log`。
