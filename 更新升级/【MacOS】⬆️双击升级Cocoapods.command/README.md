...
- 本自述文件对应脚本：`【MacOS】⬆️双击升级Cocoapods.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⬆️双击升级Cocoapods.command` |
...
```shell
chmod +x './【MacOS】⬆️双击升级Cocoapods.command'
'./【MacOS】⬆️双击升级Cocoapods.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⬆️双击升级Cocoapods.log`。
