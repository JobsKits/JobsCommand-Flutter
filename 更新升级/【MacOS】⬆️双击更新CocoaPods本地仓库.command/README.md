# `【MacOS】⬆️双击更新CocoaPods本地仓库.command`
...
- 本自述文件对应脚本：`【MacOS】⬆️双击更新CocoaPods本地仓库.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⬆️双击更新CocoaPods本地仓库.command` |
...
```shell
chmod +x './【MacOS】⬆️双击更新CocoaPods本地仓库.command'
'./【MacOS】⬆️双击更新CocoaPods本地仓库.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⬆️双击更新CocoaPods本地仓库.log`。
