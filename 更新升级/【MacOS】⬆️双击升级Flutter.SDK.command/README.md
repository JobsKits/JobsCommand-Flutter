# `【MacOS】⬆️双击升级Flutter.SDK.command`
...
- 本自述文件对应脚本：`【MacOS】⬆️双击升级Flutter.SDK.command`。
...
```shell
chmod +x './【MacOS】⬆️双击升级Flutter.SDK.command'
'./【MacOS】⬆️双击升级Flutter.SDK.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⬆️双击升级Flutter.SDK.log`。
