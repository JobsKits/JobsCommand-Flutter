...
- 本自述文件对应脚本：`【MacOS】⚙️下载配置系统环境变量.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⚙️下载配置系统环境变量.command` |
...
```shell
chmod +x './【MacOS】⚙️下载配置系统环境变量.command'
'./【MacOS】⚙️下载配置系统环境变量.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⚙️下载配置系统环境变量.log`。
