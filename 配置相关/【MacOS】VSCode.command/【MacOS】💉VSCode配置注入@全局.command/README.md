...
- 本自述文件对应脚本：`【MacOS】💉VSCode配置注入@全局.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】💉VSCode配置注入@全局.command` |
...
```shell
chmod +x './【MacOS】💉VSCode配置注入@全局.command'
'./【MacOS】💉VSCode配置注入@全局.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】💉VSCode配置注入@全局.log`。
