# `【MacOS】⚙️配置Android Studio.command`
...
- 本自述文件对应脚本：`【MacOS】⚙️配置Android Studio.command`。
...
```shell
chmod +x './【MacOS】⚙️配置Android Studio.command'
'./【MacOS】⚙️配置Android Studio.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⚙️配置Android Studio.log`。
