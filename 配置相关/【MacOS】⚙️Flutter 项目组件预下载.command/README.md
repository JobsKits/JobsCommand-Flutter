# `【MacOS】⚙️Flutter 项目组件预下载.command`
...
- 本自述文件对应脚本：`【MacOS】⚙️Flutter 项目组件预下载.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⚙️Flutter 项目组件预下载.command` |
...
```shell
chmod +x './【MacOS】⚙️Flutter 项目组件预下载.command'
'./【MacOS】⚙️Flutter 项目组件预下载.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⚙️Flutter 项目组件预下载.log`。
