# `【MacOS】☀️双击运行Flutter项目（iOS 模拟器）.command`
...
- 本自述文件对应脚本：`【MacOS】☀️双击运行Flutter项目（iOS 模拟器）.command`。
...
```shell
chmod +x './【MacOS】☀️双击运行Flutter项目（iOS 模拟器）.command'
'./【MacOS】☀️双击运行Flutter项目（iOS 模拟器）.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】☀️双击运行Flutter项目（iOS 模拟器）.log`。
