...
- 本自述文件对应脚本：`【MacOS】🐦Flutter自动化生产代码.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】🐦Flutter自动化生产代码.command` |
...
```shell
chmod +x './【MacOS】🐦Flutter自动化生产代码.command'
'./【MacOS】🐦Flutter自动化生产代码.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】🐦Flutter自动化生产代码.log`。
