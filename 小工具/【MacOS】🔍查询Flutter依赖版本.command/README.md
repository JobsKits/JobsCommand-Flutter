...
- 本自述文件对应脚本：`【MacOS】🔍查询Flutter依赖版本.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】🔍查询Flutter依赖版本.command` |
...
```shell
chmod +x './【MacOS】🔍查询Flutter依赖版本.command'
'./【MacOS】🔍查询Flutter依赖版本.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】🔍查询Flutter依赖版本.log`。
