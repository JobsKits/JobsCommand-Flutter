# `【MacOS】♻️修复Flutter项目中文路径.command`
...
- 本自述文件对应脚本：`【MacOS】♻️修复Flutter项目中文路径.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】♻️修复Flutter项目中文路径.command` |
...
```shell
chmod +x './【MacOS】♻️修复Flutter项目中文路径.command'
'./【MacOS】♻️修复Flutter项目中文路径.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】♻️修复Flutter项目中文路径.log`。
