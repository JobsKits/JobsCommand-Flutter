...
- 本自述文件对应脚本：`【MacOS】🛠️Android 模拟器一键检测与修复.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】🛠️Android 模拟器一键检测与修复.command` |
...
```shell
chmod +x './【MacOS】🛠️Android 模拟器一键检测与修复.command'
'./【MacOS】🛠️Android 模拟器一键检测与修复.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】🛠️Android 模拟器一键检测与修复.log`。
