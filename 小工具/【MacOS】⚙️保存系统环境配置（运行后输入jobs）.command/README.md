# `【MacOS】⚙️保存系统环境配置（运行后输入jobs）.command`
...
- 本自述文件对应脚本：`【MacOS】⚙️保存系统环境配置（运行后输入jobs）.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⚙️保存系统环境配置（运行后输入jobs）.command` |
...
```shell
chmod +x './【MacOS】⚙️保存系统环境配置（运行后输入jobs）.command'
'./【MacOS】⚙️保存系统环境配置（运行后输入jobs）.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⚙️保存系统环境配置（运行后输入jobs）.log`。
