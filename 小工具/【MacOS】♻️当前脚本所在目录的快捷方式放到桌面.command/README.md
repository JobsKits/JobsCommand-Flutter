...
- 本自述文件对应脚本：`【MacOS】♻️当前脚本所在目录的快捷方式放到桌面.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】♻️当前脚本所在目录的快捷方式放到桌面.command` |
...
```shell
chmod +x './【MacOS】♻️当前脚本所在目录的快捷方式放到桌面.command'
'./【MacOS】♻️当前脚本所在目录的快捷方式放到桌面.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】♻️当前脚本所在目录的快捷方式放到桌面.log`。
