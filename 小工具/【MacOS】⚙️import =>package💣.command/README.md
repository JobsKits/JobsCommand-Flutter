...
- 本自述文件对应脚本：`【MacOS】⚙️import =>package💣.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⚙️import =>package💣.command` |
...
```shell
chmod +x './【MacOS】⚙️import =>package💣.command'
'./【MacOS】⚙️import =>package💣.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⚙️import =>package💣.log`。
