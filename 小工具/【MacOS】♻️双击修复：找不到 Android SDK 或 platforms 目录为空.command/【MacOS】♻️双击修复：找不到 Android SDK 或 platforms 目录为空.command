...
# - 核心用途：执行“♻️双击修复：找不到 Android SDK 或 platforms 目录为空”对应的移动端项目自动化任务。
...
show_readme_and_wait() {
  clear
  print -r -- '============================== 脚本内置自述 =============================='
  print -r -- '脚本名称：【MacOS】♻️双击修复：找不到 Android SDK 或 platforms 目录为空.command'
  print -r -- '核心用途：执行“♻️双击修复：找不到 Android SDK 或 platforms 目录为空”对应的移动端项目自动化任务。'
