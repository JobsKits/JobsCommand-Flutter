...
- 本自述文件对应脚本：`【MacOS】🧹Flutter清理维护工具.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】🧹Flutter清理维护工具.command` |
...
```shell
chmod +x './【MacOS】🧹Flutter清理维护工具.command'
'./【MacOS】🧹Flutter清理维护工具.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】🧹Flutter清理维护工具.log`。
