# `【MacOS】🛠️Flutter 插件 namespace 修复工具".command`
...
- 本自述文件对应脚本：`【MacOS】🛠️Flutter 插件 namespace 修复工具".command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】🛠️Flutter 插件 namespace 修复工具".command` |
...
```shell
chmod +x './【MacOS】🛠️Flutter 插件 namespace 修复工具".command'
'./【MacOS】🛠️Flutter 插件 namespace 修复工具".command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】🛠️Flutter 插件 namespace 修复工具".log`。
