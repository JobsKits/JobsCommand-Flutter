...
# - 核心用途：执行“🛠️Flutter 插件 namespace 修复工具"”对应的移动端项目自动化任务。
...
show_readme_and_wait() {
  clear
  print -r -- '============================== 脚本内置自述 =============================='
  print -r -- '脚本名称：【MacOS】🛠️Flutter 插件 namespace 修复工具".command'
  print -r -- '核心用途：执行“🛠️Flutter 插件 namespace 修复工具"”对应的移动端项目自动化任务。'
