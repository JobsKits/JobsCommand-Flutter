...
- 本自述文件对应脚本：`【MacOS】⚙️双击显示隐藏文件.command`。
...
```shell
chmod +x './【MacOS】⚙️双击显示隐藏文件.command'
'./【MacOS】⚙️双击显示隐藏文件.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⚙️双击显示隐藏文件.log`。
