# `【MacOS】⚙️双击更换Cocoapods源[-]CDN[+]Github.command`
...
- 本自述文件对应脚本：`【MacOS】⚙️双击更换Cocoapods源[-]CDN[+]Github.command`。
- 脚本原始位置：`JobsGenesis@JobsCommand.Flutter/Cocoapods`。
- 脚本定位：处理 CocoaPods 安装、更新、Podfile 或 Pods 工程相关流程。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⚙️双击更换Cocoapods源[-]CDN[+]Github.command` |
| 所属目录 | `JobsGenesis@JobsCommand.Flutter/Cocoapods` |
| 主要标签 | `CocoaPods` |
| 是否涉及 Homebrew | `否` |
| 是否可能联网 | `否` |
| 是否含高风险命令 | `是` |
...
```shell
chmod +x './【MacOS】⚙️双击更换Cocoapods源[-]CDN[+]Github.command'
'./【MacOS】⚙️双击更换Cocoapods源[-]CDN[+]Github.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⚙️双击更换Cocoapods源[-]CDN[+]Github.log`。
