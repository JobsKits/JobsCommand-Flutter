...
- 本自述文件对应脚本：`【MacOS】⚙️Pod_Install.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⚙️Pod_Install.command` |
...
```shell
chmod +x './【MacOS】⚙️Pod_Install.command'
'./【MacOS】⚙️Pod_Install.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⚙️Pod_Install.log`。
